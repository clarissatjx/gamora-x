...
| Official Test score | **0.875** — true car ranked 2nd (submitted `04\|01\|…`, so the faulty car is `01`) | Known only from the leaderboard; not used to select the fix (see §2) |
